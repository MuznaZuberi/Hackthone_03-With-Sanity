          ...
          <svg
           ...
           <svg
            ...
            <Image
              ...
              height = {600}
            />
            <button className = "absolute py-1 font-sans font-bold bottom-0 rounded-b-lg text-white opacity-0 group-hover:opacity-100 trasaction duration-300 w-full text-center">View Details</button>
           </div>
           ...
           <Image
              ...
              height = {600}
            />
            <button className = " absolute py-1 font-sans font-bold bottom-0 rounded-b-lg text-white opacity-0 group-hover:opacity-100 trasaction duration-300 w-full text-center">View Details
            </button>
            </div>
            <h2 className="text-xl font-sans text-black mt-5">
